...
use bindings::exports::golem::search_algolia::core::Guest;
use bindings::golem::search_algolia::types::{
...
impl Guest for Component {
    ...
    fn create_index(name: IndexName, schema: Option<Schema>) -> Result<(), SearchError> {
        let client = AlgoliaClient::new().map_err(|e| SearchError::Internal(e.to_string()))?;
