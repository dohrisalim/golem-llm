...
use bindings::exports::golem::search_elastic::core::Guest;
use bindings::golem::search_elastic::types::{
    IndexName, DocumentId, Doc, Schema, SearchQuery, SearchResults, SearchHit, SearchError
};
use client::ElasticClient;
...
impl Guest for Component {
    ...
    fn create_index(name: IndexName, schema: Option<Schema>) -> Result<(), SearchError> {
        let client = ElasticClient::new().map_err(|e| SearchError::Internal(e.to_string()))?;
