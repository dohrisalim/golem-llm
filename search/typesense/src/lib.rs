...
use bindings::exports::golem::search_typesense::core::Guest;
use bindings::golem::search_typesense::types::{
    IndexName, DocumentId, Doc, Schema, SearchQuery, SearchResults, SearchHit, SearchError
};
use client::TypesenseClient;
...
impl Guest for Component {
    ...
    fn create_index(name: IndexName, schema: Option<Schema>) -> Result<(), SearchError> {
        let client = TypesenseClient::new().map_err(|e| SearchError::Internal(e.to_string()))?;
