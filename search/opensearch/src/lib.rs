...
use bindings::exports::golem::search_opensearch::core::Guest;
use bindings::golem::search_opensearch::types::{
    IndexName, DocumentId, Doc, Schema, SearchQuery, SearchResults, SearchHit, SearchError
};
use client::OpenSearchClient;
...
impl Guest for Component {
    ...
    fn create_index(name: IndexName, schema: Option<Schema>) -> Result<(), SearchError> {
        let client = OpenSearchClient::new().map_err(|e| SearchError::Internal(e.to_string()))?;
